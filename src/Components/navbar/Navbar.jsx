        ...
        <div> 
            <div className=' bg-blue-50'>
                <div id='main' className='bg-blue-400 flex justify-between '>
                    <li  >
                        <NavLink to='/' > <h1 onClick={() => { setIsActive(0) }} className={
                    ...
                    <li>
                        <NavLink to='/daily' >  <h1 onClick={() => { setIsActive(1) }} className={
                    ...
                    <li>
                        <NavLink to='/weekly'><h1 onClick={() => { setIsActive(2) }} className={
                    ...
                    <li>
                        <NavLink to='monthly' >   <h1 onClick={() => { setIsActive(3) }} className={
                    ...
                    <li>
                        <NavLink to='/yearly'>   <h1 onClick={() => { setIsActive(4) }} className={
